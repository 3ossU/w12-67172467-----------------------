...
import babyImg from './img/human.png'
import pinkypieImg from './img/cartoon.png'
...
const Animation = () => {
  ...
  const [ballImage, setBallImage] = useState(undefined) // undefined = ยังไม่เลือกอะไร
      ...
      >
        <div
          ...
          style={{
            ...
            backgroundPosition: 'center',
            backgroundColor:
              ballImage === null ? '#0b82ebff' : 'transparent',
          }}
        ></div>
      </div>
